                ...
                if selected_record:
                    ...
                    if is_prof_sum_akt:
                        ...
                        <tr style="vertical-align: top !important;">
                            ...
                            <td style="border: 1px solid #000; padding: 8px; vertical-align: top !important; word-break: break-word;"><b>Add Cost:</b><br>{deskripsi_keterangan_inv}</td>
                        ...
                        <tr style="vertical-align: top !important;">
                            ...
                            <td style="border: 1px solid #000; padding: 8px; vertical-align: top !important; word-break: break-word;"><b>Management Fee / Handling Fee (15%):</b><br>Layanan manajemen & pengelolaan operasional terkait</td>
                            <td style="border: 1px solid #000; padding: 8px; text-align: center; vertical-align: top !important;">-</td>
                            <td style="border: 1px solid #000; padding: 8px; text-align: right; vertical-align: top !important;">-</td>
                        ...
                        for idx_m2, row_m2 in enumerate(matched_items_m2, 1):
                            ...
                            <tr style="vertical-align: top !important;">
                                ...
                                <td style="border: 1px solid #000; padding: 8px; vertical-align: top !important; word-break: break-word;">{desc_full}</td>
                        ...
                        tabel_item_html = f"""
                        <tr style="vertical-align: top !important;">
                            <td style="border: 1px solid #000; padding: 10px 8px; text-align: center; vertical-align: top !important;">1</td>
                            <td style="border: 1px solid #000; padding: 10px 8px; vertical-align: top !important; word-break: break-word;"><b>{deskripsi_keterangan_inv}</b></td>
                            <td style="border: 1px solid #000; padding: 10px 8px; text-align: center; vertical-align: top !important;">-</td>
                            <td style="border: 1px solid #000; padding: 10px 8px; text-align: right; vertical-align: top !important;">-</td>
                            <td style="border: 1px solid #000; padding: 10px 8px; text-align: right; vertical-align: top !important;">Rp {val_inv:,.2f}</td>
                        </tr>
                        """
                        total_amount_due = val_inv
                        discount_10_nominal = 0.0
