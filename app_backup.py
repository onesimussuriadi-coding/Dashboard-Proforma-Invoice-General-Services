    ...
    if user_role == "Staff Timesheet":
        ...
        # =========================================================================
            ...
            if menu == "Input Database & Invoice (31 Kolom)":
                ...
                # PERBAIKAN UTAMA: Parsing tanggal yang sangat fleksibel agar tidak mereset ke today()
        ...
        # =========================================================================
            ...
            if menu == "Input & Proses Rincian Pekerjaan":
                ...
                if not saved_db:
                    ...
                    with col_load2:
                        if st.button("📥 Panggil Data Ini"):
                            # PERBAIKAN UTAMA: MEMBERSIHKAN GHOST STATE WIDGET SEBELUMNYA
                            ...
                            if pilihan_load_tx != "-- Buat Baru / Input Baru --":
                                ...
                                if matched_tx_items:
                                    ...
                                    # Mengatur jumlah baris agar persis sama dengan jumlah item PI
                                    st.session_state["num_rows"] = len(matched_tx_items)
                                
                                st.success(f"✅ Data untuk PI [{pi_target}] berhasil dipanggil secara otomatis dan presisi ({len(matched_tx_items)} baris item)!")
                                st.rerun()
                            else:
